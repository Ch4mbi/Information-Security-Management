...
* **Bolsa/Inversiones:** Aquí, gracias a los servicios digitales del banco, este está al día con el estado de otras áreas financieras de todo el mundo. Se pueden gestionar carteras digitales y comprar o vender activos financieros de diversos grupos.  
* **Transacciones:** Pagos digitales y/o transacciones seguras entre diversos individuos con seguridad implementada adecuadamente por el banco.  
* **Resguardos:** Resguardo de activos como cuentas bancarias, depósitos, almacenamiento de dinero, etc.  
* **Seguros:** Servicios de seguros respecto a robos, accidentes, problemas de salud, etc.  
* **Préstamos:** Préstamos para aquellos que los necesiten. De los cuales, se deberán devolver en un periodo de tiempo acordado con el cliente que lo solicita con cierto porcentaje de intereses, pudiendo variar en base a los tiempos de pago o la cantidad pedida.
...
ChamBank almacena información confidencial de clientes individuales o de empresas/compañías que nos tengan como servicio. También el banco cuenta con colaboradores externos que aportan más ayuda a ampliar y mantener los servicios del banco. Esto se menciona ya que, en estos aspectos, en general, existen una serie de activos que hay que tener en cuenta:

* Datos personales de clientes: El banco almacena datos de los clientes en los servidores y en la nube, a los cuales los que tienen permisos pueden acceder y trabajar con ellos.  
...
Al ser un banco europeo, se encuentra en un entorno competitivo con otras entidades similares. Al igual que otros servicios financieros, este banco está atado a diversas regulaciones y reglamentos que está obligado a seguir como:
...
* Ciberamenazas como phishing, malware, ransomware, troyanos, etc.  
* Otros bancos   
...
## **1.4. Justificación de aplicación de SGSI**

La implantación de un SGSI, aparte de poder llegar a ser “opcional” para varias entidades (en ciertos casos), es una recomendación muy buena a tener en cuenta. Para ChamBank, la implantación de un SGSI ayuda en varios aspectos como: 

| Justificación | Explicación |
| :---: | ----- |
|  **Cumplimiento normativo y regulatorio** | En varios sectores, como el bancario en este caso, están estrictamente regulados y deben cumplir varias normativas internacionales. Dichas normativas están relacionadas con la seguridad, privacidad de los datos, y la resiliencia operativa. Con un SGSI se puede demostrar el cumplimiento normativo en auditorías, establecer tiempos tanto de auditorías como de respuesta, recuperación, etc., también puede reducir sanciones regulatorias, y puede ayudar a establecer controles de seguridad. |
| **Ayuda en la protección de activos y los riesgos de los mismos** | ChamBank, como entidad financiera, gestiona grandes volúmenes de datos sensibles de clientes, empleados, o terceros. Un SGSI ayuda a la identificación de activos críticos, a evaluar riesgos sobre dichos activos, puede ayudar a aplicar controles de seguridad haciendo que se reduzca la probabilidad de dichos riesgos o el impacto potencial que pueden llegar a tener. |
|  **Ayuda a mantener la resiliencia** | La indisponibilidad de los servicios bancarios lleva a pérdidas económicas, afecta a la reputación del banco, y lleva a incumplimientos regulatorios y, por ende, a sanciones legales y monetarias. Un SGSI implementa planes de continuidad, o de resiliencia, y ayuda a la gestión de incidentes con análisis de riesgos y playbooks útiles ante los incidentes. |
|  **Reputación y confianza de los clientes** | Como ya se ha mencionado, un banco que no pueda dar servicios por ataques afecta a la confianza de los clientes y, por ende, a la reputación del banco. Un SGSI ayuda a solucionar dicho resultado asegurando a los clientes el compromiso con la seguridad de la información que el banco tiene, también les muestra madurez y la capacidad para gestionar riesgos e incidentes. |
|  **Gestión de recursos** | Normalmente las entidades bancarias cuentan con el apoyo de otras entidades de terceros, como proveedores cloud, servicios extra, etc. El SGSI ayuda a gestionar riesgos de terceros, también a monitorizar el cumplimiento de seguridad de estos y permite establecerles requisitos o limites operativos o de alcance de estos |
|  **Buena práctica** | Un SGSI bien implantado impulsa a la formación y concienciación de los empleados respecto a la seguridad, ayudando a la reducción de errores humanos reduciendo una buena parte de los riesgos. |
|  **Mejora continua** | El SGSI impulsa al banco a mejorar de manera continua. Esto se debe en parte a las regulaciones ya que el banco debe de estar al día respecto a las normativas que siga con el SGSI o que se le imponga. También ayuda a adaptarse ante nuevas amenazas, aprender de errores pasados (humanos, operacionales, etc.) y a evolucionar para estar al día respecto a la competencia.  |

## **1.5. Partes interesadas** 

Tras analizar la justificación de la implantación de un SGSI, también hay que pensar en a quienes interna y externamente les interesa dicha implantación del sistema ya sea por beneficio, seguridad, confianza, etc. Algunos de los posibles interesados son:

* Los clientes son los primeros que se deben de sentir “integrados” externamente, es decir, a los clientes les interesa saber que su banco está siguiendo buenas prácticas y que sabe gestionar incidentes y asegurar sus datos.  
* El CISO sería el responsable de coordinar la implantación del SGSI, por lo que es el primer interesado interno (junto con la dirección de la que forma parte) en implantar dicho sistema de manera correcta.  
* Los empleados están interesados y es interesante desde el punto de vista de la alta dirección. Ambos están interesados en que los trabajadores del banco estén bien formados en seguridad para reducir, por ejemplo, el error humano o para mejorar procesos.  
* Los auditores están interesados ya que el SGSI tiene una función de mejora continua respecto a eventos pasados, es decir, los auditores, aparte de asegurarse de que el SGSI esté bien implantado con reglamentos bien definidos, quieren ver que la entidad bancaria funcione correctamente y que no tengan que sancionar a ChamBank.  
* Los proveedores o terceros están interesados ya que, al querer hacer tratos con ChamBank, quieren saber el alcance que tienen, si ellos van a estar seguros, que medidas de seguridad se implementarán, etc.
...
| Roles | Explicación de los roles |
| ----- | ----- |
|  **CEO (Chief Executive Officer)** | Colabora con el resto de los líderes para asegurar la defensa de la información y los activos del banco frente a ciberataques. Aparte de que es el responsable de obtener los recursos para lograr dicha defensa y establecer e implementar una estrategia útil. |
| **CSO (Chief Security Officer)** | Es el responsable de la seguridad física y tecnológica del banco. |
| **CISO (Chief Information Security Officer)** | Es el responsable de la seguridad de la información aplicando diversas medidas de seguridad y respuestas ante los eventos de seguridad. |
|  **CTO (Chief Technology Officer)** | Es el responsable de la innovación tecnológica del banco y de los cumplimientos legales de la misma. Tiene como objetivo planificar la estrategia IT y desarrollar y gestionar nuevos proyectos (Aparte de que se puede considerar que “ayude” al CISO respecto a la innovación). |
| **CDO (Chief Data Officer)** | Asegura el correcto tratamiento de los datos y que vayan acorde a las leyes dichas manipulaciones. |
|  **Pentester** | A pesar de que se considera un perfil más “agresivo”, es útil para probar las nuevas medidas de seguridad sin esperar a un ataque real, aparte de que también pueden hallar vulnerabilidades no vistas en los sistemas.  |
...
* El CEO tiene la responsabilidad de aprobar las estrategias de seguridad que se vayan a seguir y de administrar recursos para dichas estrategias, aunque no de forma total. Será el responsable de aceptar los riesgos residuales tras que lo haga el comité de seguridad.  
* El CISO tiene autoridad para gestionar el SGSI, implementar controles y medidas de seguridad y es el responsable de coordinar la respuesta ante incidentes. Será el responsable de evaluar riesgos y proponer medidas.  
...
* El CTO debe tener autoridad sobre las innovaciones tecnológicas del banco. Esto implica que debe decidir asumir riesgos con nuevos equipos o nuevos softwares que se vayan a usar, al mismo tiempo que debe estar consciente de la nueva superficie de ataque (o actualizada) que puede llegar a crear.  
...
* Se debe conformar en el banco un grupo formado por el CEO, CISO, CTO y el CDO que se encargue de revisar el estado del SGSI y de, por ende, tomar decisiones estratégicas en reuniones trimestrales.
...
* Se siguen estándares internacionales como DORA o ISO 27001.  
* Se tiene como objetivo personal seguir el SGSI y una mejora continua del mismo.

(Mota, 2023)  
(27001, 2022)  
La decisión de que el CISO reporte al CEO en lugar de al CTO se debe a que en ChamBank la seguridad de la información no es solo un problema técnico. Implica decisiones regulatorias, reputacionales y económicas que requieren de independencia funcional del área tecnológica para evitar que la innovación y la seguridad entren en conflicto por la prioridad.

# **5. Alcance** 

El alcance del SGSI de ChamBank define los sistemas, los procesos y las personas que gestionan y trabajan con información crítica para las operaciones bancarias, priorizando los activos con mayor exposición potencial y regulatoria y un mayor impacto potencial en caso de incidente:
...
Además de la identificación de activos, se tienen que definir de manera más precisa el alcance del SGSI en ChamBank, con la finalidad de decidir que sistemas, procesos y áreas organizativas están incluidos dentro del SGSI. Dentro del alcance entrarían:

* Los sistemas de banca online, como webs y apps, por ser el principal método de interacción entre los usuarios y sus cuentas.  
* La infraestructura tecnológica del banco, como redes, servidores, la nube, …  
* Los sistemas de gestión de datos financieros y personales de clientes, por lo críticos que son y las consecuencias y responsabilidades legales que conllevan (RGPD).  
* Los procesos internos que tiene el banco como gestiones, procedimientos, transacciones, préstamos, inversiones, … Tanto automatizados como manuales.  
* El personal interno con acceso a sistemas críticos dentro del banco.

Tras esta especificación de alcance, se tiene que especificar también los activos o aspectos a los que el SGSI de ChamBank no alcanza:

* Dispositivos de clientes personales ya que no son controlados por el banco.  
* Infraestructura de los terceros con los que ChamBank trabaja, aunque su impacto será considerado en planes de continuidad del negocio.

# **6. Planificación del SGSI** 

## **6.1. Metodología de análisis de riesgos** 

Se decidió que en ChamBank se adopte una metodología de análisis de riesgos mixta, combinando análisis cuantitativo y cualitativo por su contexto bancario. El análisis cualitativo permite clasificar amenazas en base a su probabilidad e impacto potencial cuando dicho impacto no se puede “monetizar”, como, por ejemplo, el aspecto reputacional. Por otro lado, el análisis cuantitativo se aplica con un enfoque más monetario o financiero, como pérdidas económicas por ataques, robos, fraude, caídas del servicio (por largos periodos) o incluso sanciones regulatorias o legales.  
Usar solo el enfoque puramente cualitativo subestimaría los riesgos financieros concretos, mientras que usar únicamente un enfoque cuantitativo ignoraría riesgos de difícil monetización, pero de alto impacto estratégico para ChamBank.  
(Team, 2025)  
La metodología de análisis de riesgos sigue 4 fases: la identificación de activos y amenazas, el análisis de riesgos, evaluación y priorización, y decidir un tratamiento para los mismos  
(27001, 2022)  
...
* Mejorar la detección (en como mucho 24 horas) y respuesta ante incidentes (En un plazo entre 24 y 72 horas).  
* Estar al día con el correcto cumplimiento de marcos como ISO 27001, DORA y RGPD.  
* Mejora continua (Actualizaciones de mejora frente a nuevas amenazas o procedimientos más actualizados).  
* Reducir los incidentes relacionados con el phishing en, al menos, un 35% en un año.
...
|  **App de banca online** | Es el canal principal de interacción entre los clientes y sus cuentas bancarias. Lo usan para llevar a cabo transacciones, gestionar sus cuentas o solicitar diversos servicios. |  Software/ Programas | • Confidencialidad: Alta<br>• Integridad:  Alta<br>• Disponibilidad: Alta |
|  **Infraestructura cloud** | Es el conjunto de servicios que aporta la nube ya sea para almacenar datos, ejecutar apps, llevar a cabo operaciones, …Una mala configuración de la misma da lugar a comprometer diversos servicios. |  Infraestructura | • Confidencialidad: Alta<br>• Integridad: Alta<br>• Disponibilidad: Alta |
|  **APIs financieras**  | Engloba las diferentes maneras de los trabajadores de comunicarse con diversos servicios, si se ven comprometidas, pueden dar acceso no autorizado a datos o permitir ejecuciones de código. |  Software/ Programas | • Confidencialidad: Alta<br>• Integridad: Alta<br>• Disponibilidad: Alta |
|  **Datos  de los empleados**  | Información personal de los empleados del banco, como credenciales de acceso, cuentas, datos administrativos, … La exposición de estos datos, aparte de la de los clientes permite facilitar ataques. |  Información | • Confidencialidad: Alta<br>• Integridad: Media<br>• Disponibilidad: Media |
|  **Registros financieros**  | Historiales, balances, transacciones y logs operacionales que sirven para mantener constancia de lo que se lleva a cabo y para seguir el cumplimiento regulatorio. |  Información | • Confidencialidad: Alta<br>• Integridad: Alta<br>• Disponibilidad: Alta  |
|  **Servicios internos**  | Son los sistemas y aplicaciones usados internamente para las operaciones del banco, formando la base tecnológica interna del banco. |  Servicios/ Programas | • Confidencialidad: Media<br>• Integridad:  Alta<br>• Disponibilidad: Alta |
|  **Servidores**  | Los equipos del banco que conecta sistemas, dispositivos, o que hostea servicios internos. Si se ven comprometidos, facilitan ataques en los que se infectan varios dispositivos. |  Infraestructura | • Confidencialidad: Alta<br>• Integridad: Alta<br>• Disponibilidad: Alta |
|  **Red  interna**  | Red que conecta sistemas dentro del banco. Si se compromete de alguna manera, puede facilitar ataques como movimientos laterales. |  Infraestructura  | • Confidencialidad: Media<br>• Integridad: Alta<br>• Disponibilidad: Alta |
|  **Empleados**  | Personal del banco que interactúa con los sistemas del mismo. Errores humanos o malas prácticas dan lugar a incidentes.  |  Factor humano | • Confidencialidad: Media<br>• Integridad: Media<br>• Disponibilidad: Alta |
|  **Clientes**  | Usuarios que usan los servicios del banco. Pueden ser víctimas de phishing que afecta, indirectamente, a la seguridad del banco. |  Factor humano | • Confidencialidad: Alta<br>• Integridad: Media<br>• Disponibilidad: Media |
...
| Activo | Riesgos |
| ----- | ----- |
|  **Datos de  clientes** | • **Phishing**: Consiste en engañar a los usuarios, clientes o empleados del banco para que o den datos personales, o que hagan transferencias.<br>• **Robo de datos**: Está vinculado parcialmente al phishing, ya que este último incita a dar datos personales (parcialmente porque el robo de datos también se puede dar en ataques o incidentes/exfiltraciones). |
|  **App de  banca online** | • **Inyecciones sql**: Ataque que manipula una consulta sql para explotar vulnerabilidades en la base de datos de la app/web. (Fortinet, 2025)<br>• **Ataques de scripting**: Los atacantes introducen cadenas de malware por vulnerabilidades. Tras introducirlo, los atacantes hacen al código malicioso parte de la propia app, permitiendo al malware afectar a otros usuarios. (Clay, 2026)<br>• **Puertos desprotegidos**: Son accesos a puertos de la app que den acceso no autorizado. |
|  **Infraestructura cloud** | • **Accesos no autorizados/Malas autenticaciones**: A pesar de que generalmente, la nube es ajena en parte a la entidad que la contrata, la seguridad depende de ambos lados.<br>• **Caídas del servicio**: Una caída del servicio cloud se puede deber a varios motivos: ataques, apagones, fallos, saturamiento, etc. Por ejemplo, si es por un ataque, el riesgo es grande, ya que el banco se ve expuesto respecto a datos de clientes que haya subido, o servicios internos o externos. Si el servicio se ve comprometido por una caída de la nube, dependiendo del tiempo de recuperación o la resiliencia del banco puede ser un riesgo considerable o ligero. |
...
|  **Servidores** | • **Ransomware**: Los ataques de ransomware son un riesgo considerable. Si logra introducirse (ya sea por culpa del factor humano o por otra clase de ataque), es un riesgo ya que puede llegar a bloquear muchos o todos los equipos del banco, y, aparte de eso, puede encriptar los datos que se almacenan, al menos localmente, en el banco, impidiendo el acceso y pidiendo un rescate que no siempre está asegurado.<br>• **Ddos**: Los ataques de denegación de servicios son más “indirectos” en general ya que, normalmente, saturan un servicio, como un servidor que hostea la plataforma y/o la web, con muchas solicitudes en poco tiempo. Esto afecta a la experiencia de los clientes impidiéndoles acceder a sus cuentas y puede llegar a afectar al personal al no poder interactuar con los servicios. |
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| Muy poco probable🡪10%<br> Poco probable🡪25%<br> Probable🡪50%<br> Muy probable🡪75%<br> Extremadamente probable🡪90% | Insignificante🡪<=10000€<br> Bajo🡪50000€<br> Moderado🡪50000-150000€<br> Considerable🡪>=750000€<br> Fatal🡪>2000000€ |
...
| :---: | :---: | ----- | ----- | ----- |
|  **Datos de clientes** |  Phishing | • **Probabilidad**: Muy probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:75%<br>• **Impacto**: 750000€<br>• **VME**: 0,75*750000=  562500€ | Es uno de los métodos de ataque más usados principalmente por la ignorancia de los clientes (en gran medida), por lo que su probabilidad de que pase es muy alta, y el impacto es considerable debido a los datos que aporta a los atacantes. |
|  **Datos de clientes** |  Robo de datos | • **Probabilidad**: Probable<br>• **Impacto**: Considerable-fatal<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 2000000€<br>• **VME**: 0.5*2000000= 1000000€ | Es una consecuencia de un ataque exitoso en el banco. Por lo que es probable que ocurra (no muy probable ya que hay equipos de defensa o IR) y el impacto potencial que puede tener puede llegar a ser fatal. |
|  **App banca online** |  Inyecciones sql | • **Probabilidad**: Probable<br>• **Impacto**: Fatal<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 2000000€<br>• **VME**: 0.5*2000000= 1000000€ | El riesgo es probable ya que hay que tener en cuenta que hoy en día no son tan efectivas como lo fueron al principio, existen medidas de seguridad que se deben implementar en un primer lugar, aunque el impacto potencial es fatal, ya que pueden alterar datos de diversas maneras con dichas inyecciones. |
|  **App banca online** |  Scripting | • **Probabilidad**: Probable<br>• **Impacto**: Considerable-fatal<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 1500000€<br>• **VME**: 0,5*1500000=  750000€ | En aplicaciones web son vulnerabilidades que se suelen repetir, por lo que es probable que ocurra, y permiten ejecutar código malicioso, por lo que pueden llegar a tener un impacto considerable o fatal. |
|  **App banca online** |  Puertos desprotegidos | • **Probabilidad**: Poco probable<br>• **Impacto**: Fatal<br>• **Riesgo**: Alto | • **Probabilidad**:25%<br>• **Impacto**: 2000000€<br>• **VME**: 0,25*200000= 500000€  | Aunque son menos frecuentes que otros, el hecho de que da acceso a los atacantes a servicios internos lo pone en un impacto alto, por lo que es un riesgo alto. |
|  **Infraestructura cloud** |  Accesos no autorizados | • **Probabilidad**: Probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 750000€<br>• **VME**: 0,5*750000=  375000€ | Una nube con seguridad mal configurada permite accesos no autorizados a datos o recursos, afectando a su confidencialidad. |
|  **Infraestructura cloud** |  Caídas del servicio | • **Probabilidad**: Probable<br>• **Impacto**: Moderado- Considerable<br>• **Riesgo**: Medio-Alto | • **Probabilidad**:50%<br>• **Impacto**: 400000€<br>• **VME**: 0,5*400000=  200000€ | Ya que puede deberse a fallos internos o a ataques, es un problema habitual, su impacto depende de la resiliencia del banco y/o de la capacidad de recuperación del mismo. |
|  **APIs financieras** |  Robo de tokens | • **Probabilidad**: Probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 750000€<br>• **VME**: 0,5*750000=  375000€ | Es un riesgo considerable por el posible robo de credenciales de acceso, permitiendo así suplantar la identidad de clientes o empleados con diversos fines, por eso tiene un impacto considerable.  |
|  **Datos de los empleados** |  Robo/ Manipulación de cuentas profesionales | • **Probabilidad**: Probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 750000€<br>• **VME**: 0,5*750000=  375000€ | El acceso a cuentas internas es probable ya que existen equipos especializados en la defensa de las cuentas, pero si llegan a penetrar los atacantes, el impacto que tiene será alto. |
| **Registros financieros** |  Manipulación de datos | • **Probabilidad**: Poco probable<br>• **Impacto**: Fatal<br>• **Riesgo**: Alto | • **Probabilidad**:25%<br>• **Impacto**: 2000000€<br>• **VME**: 0,25*200000= 500000€ | Por los controles es menos probable que pase, pero si llegase a pasar, su impacto sería crítico ya que afecta a la integridad de los datos y puede llevar, aparte del ataque en sí, a consecuencias legales y sanciones. |
|  **Servicios internos** |  Interrupciones | • **Probabilidad**: Probable<br>• **Impacto**: Moderado<br>• **Riesgo**: Medio | • **Probabilidad**:50%<br>• **Impacto**: 100000€<br>• **VME**: 0,5*100000=  50000€ | Afectan a la operativa interna y pueden ser por causas “naturales” (Apagones, por ejemplo) o intencionados, como ataques de denegación de servicios que afecten a la funcionalidad normal del sistema. |
|  **Servicios internos** |  Ataques internos (En general) | • **Probabilidad**: Probable<br>• **Impacto**: Fatal<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 2000000€<br>• **VME**: 0,5*2000000= 1000000€  | Ya que dependen de los propios ataques, son probables a que pasen, ya que un equipo de profesionales puede bloquear una mayoría de ellos, pero es posible que alguno pase desapercibido. Una vez dentro, pueden llevar a cabo diversas acciones causando así que el impacto potencial pueda llegar a ser fatal. |
|  **Servidores** |  Ransomware | • **Probabilidad**: Probable<br>• **Impacto**: Fatal<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 2000000€<br>• **VME**: 0,5*750000= 375000€ | Es una de las amenazas más grandes en toda clase de entornos, incluyendo el financiero, ya que pueden paralizar los sistemas y/o cifrar grandes volúmenes de datos. |
|  **Servidores** |  Ddos | • **Probabilidad**: Probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 750000€<br>• **VME**: 0,5*750000= 375000€ | Son ataques que afectan a la disponibilidad de los servicios, son probables a que pasen hoy en día, y su impacto es considerable dependiendo del tiempo de respuesta ante dicho ataque. |
|  **Red interna** |  Intrusión | • **Probabilidad**: Probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:50%<br>• **Impacto**: 750000€<br>• **VME**: 0,5*750000=  375000€ | La intrusión a la red puede permitir el acceso a sistemas internos y facilitar auques como movimientos laterales. |
|  **Empleados** |  Error humano | • **Probabilidad**: Probable<br>• **Impacto**: Moderado- Considerable<br>• **Riesgo**: Medio | • **Probabilidad**:50%<br>• **Impacto**: 200000€<br>• **VME**: 0,5*200000= 100000€ | Una parte de los ataques se producen gracias al error humano, por lo que es relativamente probable que ocurran, aunque su impacto puede variar dependiendo de la víctima. |
|  **Empleados** |  Dispositivos externos | • **Probabilidad**: Probable<br>• **Impacto**: Moderado<br>• **Riesgo**: Medio | • **Probabilidad**:50%<br>• **Impacto**: 100000€<br>• **VME**: 0,5*100000= 50000€ | El uso de dispositivos personales puede introducir en el banco malware, aunque el impacto puede controlarse. |
|  **Clientes** |  Fraude | • **Probabilidad**: Muy probable<br>• **Impacto**: Considerable<br>• **Riesgo**: Alto | • **Probabilidad**:75%<br>• **Impacto**: 750000€<br>• **VME**: 0,75*750000= 562500€ | Es una de las amenazas más frecuente al sector bancario, con un gran impacto reputacionales y/o económicos. |
